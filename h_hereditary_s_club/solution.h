...
bool IsHereditary_sClub(vector<long> &tau, Graph & input_graph);//check if input_graph is r-robust s-club
...
vector<long> findHeuristic_hereditary(Graph & input_graph); // find a heuristic for r-robust s-club
void vertexPeeling_Hereditary(long LB, Graph & input_graph); //vertex peeling