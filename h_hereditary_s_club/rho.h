...
long findrho3LB_iToj(long i, long j, const long & rho2_ij, Graph & input_graph); //find rho3_ij lower bound
...
void FindVBPathsByRhoUBLB_Hereditary(Graph & input_graph); //find rho >=r in a graph
