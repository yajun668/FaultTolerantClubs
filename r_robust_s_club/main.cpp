...
int main(int argc, const char * argv[]) {
    ...
    fout<<"Graph Name,#vertex,#edge,R,S,PreproTime,BuildTime,HeuTime,grbSolveTime,WallTime,";
    ...
    for(long i=0;i<new_model.num_instances;i++)
    {
        ...
        cout<<"The best " <<inputG.param_r<<"_Robust "<<inputG.param_s<<"_club objective and solution in graph "<<inputG.graphname<< " is: "<<Sol.BestObj<<endl;
